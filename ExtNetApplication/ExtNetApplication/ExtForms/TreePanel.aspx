<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TreePanel.aspx.cs" Inherits="ExtNetApplication.ExtForms.TreePanel" %>
        ...
        <Items>
            <ext:Container ID="Container1" runat="server">
                ...
                <Items>
                    ...
                    <ext:TreePanel ID="TreePanel2" runat="server" Title="TreePanel with lines" Width="300"
                        Height="200" Margin="10" RootVisible="false" Lines="true" UseArrows="false" StoreID="TreeStore1" />
                    <ext:TreePanel ID="TreePanel3" runat="server" Title="TreePanel with arrows" Width="300"
                        Height="200" Margin="10" RootVisible="false" Lines="false" UseArrows="true" StoreID="TreeStore1" />
                </Items>
            </ext:Container>
        </Items>
    </ext:Viewport>
