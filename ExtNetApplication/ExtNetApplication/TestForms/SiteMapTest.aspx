<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SiteMapTest.aspx.cs" Inherits="ExtNetApplication.TestForms.SiteMapTest" %>
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="BorderLayout">
            <Items>
                ...
                <ext:TreePanel 
                    ...
                    <Store>
                        <ext:TreeStore ID="TreeStore1" runat="server" OnReadData="LoadPages">
                            <Proxy>
                                <ext:PageProxy />
                            </Proxy>
                        </ext:TreeStore>
